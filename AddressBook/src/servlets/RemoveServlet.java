        ...
        if (b == null || !b) {
            ...
            try {
                for (Contact u : process.viweAll(filename)) {
                    out.println("<tr><td><input type=\"checkbox\" name =\"dzen\" value =" + arrindex++ + ">" + "  " + number++ + "</td><td>" + u.getFirstName() + "</td><td>" + u.getLastName() + "</td><td>" + u.getEmail() + "</td><td>" + u.getPhone() + "</td></tr>");
                }
            } catch (Exception e) {
                e.printStackTrace();
            }
